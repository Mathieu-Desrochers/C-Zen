...
define(function_param_expanded, `ifelse(`$2', `%d', `$1', `$2', `%pd', *`$1')')

define(function_params_expanded, `[`$1'][`$2']')
define(function_params_expanded_iter, `ifelse(`$1', `', `$3', `function_params_expanded_iter(
  pop(`$1'), pop(`$2'), `$3`'function_param_expanded(peek(`$1'), peek(`$2'))')')')
...
function_params_expanded_iter(`x y', `%pd %d', `')
