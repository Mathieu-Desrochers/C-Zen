  ...
  int *validation_errors_count)
{
  ...
  int order_item_ids_array_find_unknowns_result = array_find_unknowns_int(
  ...
  check(order_item_ids_array_find_unknowns_result == 0, "order_item_ids_array_find_unknowns_result: %d",
    order_item_ids_array_find_unknowns_result);
